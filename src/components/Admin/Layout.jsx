...
const Layout = ({children})=>{
  ...
  return(
    ...
    <div className="md-hidden block">
      <aside 
            className="w-[280px] bg-indigo-500 fixed top-0 left-0 h-full z-50 overflow-hidden "
            style={{
              width : mobilesize,
              transition : '0.3s'
            }}
        ...
        {/* <h1>Hello</h1> */}
          ...
          <nav className="bg-white p-6 shadow flex items-center justify-between sticky top-0 left-0">
             <div className="flex gap-4 items-center">
                  ...
                  <button onClick={()=>setMobileSize(mobilesize === 0 ? 280 : 0)} className="bg-gray-50 hover:bg-indigo-500 hover:text-white w-8 h-8">
                 <i className="ri-menu-2-line text-xl "></i>
                  </button>
